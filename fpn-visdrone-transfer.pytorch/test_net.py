...
if __name__ == '__main__':
    ...
    print(args.load_dir, args.net, args.dataset)
    # input_dir = args.load_dir[0] + "/" + args.net + "/" + args.dataset   #ORIGINAL
    # input_dir = "../fpn-uav.pytorch/models/altitude=0.01_angle=0.01_weather=0.01/Restart"
    ...
    path = os.path.join('data/results', str(args.checkpoint), str(args.checksession))
