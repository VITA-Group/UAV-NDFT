...
# Propose boxes
__C.TEST.HAS_RPN = True               ##False (originally true)
...
__C.PIXEL_MEANS = np.array([[[95.10228701814152,96.48541142770978,
92.98479118259208]]])
...
__C.ANCHOR_SCALES = [1,2,4,8,16] #CHANGED FROM [8,16,32]
...
__C.FPN_ANCHOR_SCALES = [16, 32, 64, 128, 256] #CHANGED FROM [32,64,128,256,512]
