...
class uav(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        ...
        self._altitudes = ('low-alt', 'high-alt')
        ...
        self._altitude_to_ind = {'low-alt': 0, 'medium-alt': 1, 'high-alt': 1}
        self._angle_to_ind = {'front-view': 0, 'side-view': 1, 'bird-view': 1}
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join('data', 'UAV_devkit' + self._year)
    ...
    def _write_voc_results_file(self, path, all_boxes):
        for cls_ind, cls in enumerate(self.classes):
            if cls == '__background__':
                continue
            print('Writing {} UAV results file'.format(cls))
    ...
    def _write_voc_results_file_attributes(self, path, all_boxes, attr_name):
        ...
        for ind, attr in enumerate(attributes):
            print('Writing {} UAV results file'.format(attr))
